...
async function subit() {
  ...
  await Forkliftdetail.updateMany(
    { "tyres.tyretype": "None-Marking S/E Solid Tyres" },
    { $set: { "tyres.$.tyretype": "Non-Marking S/E Solid Tyres" } },
    function(err) {
      if (err) console.log("find Many Failed");
    }
  );
  ...
  await Forkliftdetail.updateMany(
    { "tyres.tyretype": "None-Marking White Tyres" },
    { $set: { "tyres.$.tyretype": "Non-Marking White Tyres" } },
    function(err) {
      if (err) console.log("find Many Failed");
    }
  );
